defmodule Samwise.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import Samwise.ModelCase
    end
  end

  setup tags do
    :ok = Ecto.Adapters.SQL.Sandbox.checkout(Samwise.Repo)

    unless tags[:async] do
      Ecto.Adapters.SQL.Sandbox.mode(Samwise.Repo, {:shared, self()})
    end
