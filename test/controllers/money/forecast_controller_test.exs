defmodule Samwise.Money.ForecastControllerTest do
  ...
  test "adds items to dates list" do
    ...
    balance = 1000
    expected_list = [
      %{date: "2/11/1982", day: 11, balance: 1000, items: []},
      %{date: "2/12/1982", day: 12, balance: 4488.01, items: [
        %{amount: 3500, due: 12, name: "Husk", type: "income"},
        %{amount: 11.99, due: 12, name: "Hulu", url: "hulu.com", type: "bill"}
      ]},
      %{date: "2/13/1982", day: 13, balance: 4477.66, items: [
        %{amount: 10.35, due: 13, name: "XBox Gold", url: "xbox.com", type: "bill"}
      ]},
      %{date: "2/14/1982", day: 14, balance: 4477.66, items: []},
      %{date: "2/15/1982", day: 15, balance: 4477.66, items: []}
    ]
